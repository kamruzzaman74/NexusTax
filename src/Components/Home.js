...
function Home() {
  return (
    <>
      <div className="homepage-container bg-blue-900 text-white flex flex-col justify-center items-center py-24 px-4 md:px-8 relative overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-full z-0"></div>
        <div className="text-center relative z-10">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 md:mb-6 animate__animated animate__fadeInDown">Welcome to Our Company</h1>
